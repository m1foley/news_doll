...
class NewsItemsControllerTest < ActionController::TestCase
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post :create, news_item: { body: @news_item.body, created_by_id: @news_item.created_by_id, title: @news_item.title }
    end
  ...
  test "should update news_item" do
    put :update, id: @news_item, news_item: { body: @news_item.body, created_by_id: @news_item.created_by_id, title: @news_item.title }
    assert_redirected_to news_item_path(assigns(:news_item))
  end
